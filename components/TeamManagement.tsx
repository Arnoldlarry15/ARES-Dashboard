...
export const TeamManagement: React.FC<TeamManagementProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 rounded-xl text-white text-sm font-bold shadow-lg glow-emerald transition-all"
            >
          ...
          <div className="glass-strong rounded-2xl p-6 w-full max-w-md shadow-2xl border border-white/10">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 glass-strong rounded-xl text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 transition-all font-medium"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 glass-strong rounded-xl text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 transition-all font-medium"
                >
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 rounded-xl text-white font-bold shadow-lg transition-all"
              >
                Send Invite
              </button>
            </div>
      ...
      {/* Notification */}
      {notification && (
        <div className="fixed bottom-6 right-6 z-[220] glass-strong px-6 py-3 rounded-xl border border-emerald-500/30 shadow-2xl animate-in slide-in-from-bottom">
